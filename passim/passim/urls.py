...
urlpatterns = [
    ...
    url(r'^ssg/huwa/indiculum/$', EqualGoldHuwaIndiculum.as_view(), name='equalgold_huwaindiculum'),
    url(r'^ssg/huwa/nebenwerk/$', EqualGoldHuwaNebenwerk.as_view(), name='equalgold_huwanebenwerk'),
